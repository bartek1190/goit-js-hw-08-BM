...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ed(t)||0,ef(n)&&(s=!!n.leading,i=(f="maxWait"in n)?ec(ed(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(es())},m}(e,t,{leading:r,maxWait:t,trailing:o})};let eh=document.querySelector("iframe"),ep=new B(eh),ev="videoplayer-current-time";ep.on("play",function(){console.log("played the video!")}),ep.getVideoTitle().then(function(e){console.log("title:",e)});let ey=((a=J)&&a.__esModule?a.default:a)(e=>{localStorage.setItem(ev,e.seconds)},1e3);ep.on("timeupdate",ey),ep.on("loaded",()=>{let e=localStorage.getItem(ev);e&&ep.setCurrentTime(Number.parseFloat(e)).catch(function(e){e.name})})}();//# sourceMappingURL=02-video.00eaea48.js.map

//# sourceMappingURL=02-video.00eaea48.js.map
